...
<body>
    <nav id="navbar" class="navbar navbar-collapse" role="navigation">
        ...
        <form action="#" id="rental_form" method="post">
            <div class="row" id="content">
                ...
                <div class="col-xs-12 col-sm-6 col-md-6 col-lg-4">
                    ...
                    <select name="dateOfBirth" class="day selectpicker">
                        <option disabled selected="selected">Day</option>
                    </select>
                    <select name="dateOfBirth" class="month selectpicker">
                        <option disabled selected="selected">Month</option>
                    </select>
                    <select name="dateOfBirth" class="year selectpicker">
                ...
                <div class="col-xs-12 col-sm-6 col-md-6 col-lg-4">
                    <div class="form-group">
                        <select name="relation" class="selectpicker form-control relation_btn">
                ...
                <div class="col-xs-12 col-sm-6 col-md-6 col-lg-4">
                    ...
                    <select name="dateIn" class="day selectpicker">
                        <option disabled selected="selected">Day</option>
                    </select>
                    <select name="dateIn" class="month selectpicker">
                        <option disabled selected="selected">Month</option>
                    </select>
                    <select name="dateIn" class="year selectpicker">
                        <option disabled selected="selected">Year</option>
                    </select>
                </div>
                <div class="col-xs-12 col-sm-6 col-md-6 col-lg-4">
                    <label for="dateOut">date out</label><br/>
                    <select name="dateOut" class="day selectpicker">
                        <option disabled selected="selected">Day</option>
                    </select>
                    <select name="dateOut" class="month selectpicker">
                        <option disabled selected="selected">Month</option>
                    </select>
                    <select name="dateOut" class="year selectpicker">
                        <option disabled selected="selected">Year</option>
                    </select>
                </div>
                <div class="clearfix visible-lg-block"></div>
                ...
                <div class="col-xs-12 col-sm-6 col-md-6 col-lg-4">
                    ...
                    <select name="startDate" class="day selectpicker">
                        <option disabled selected="selected">Day</option>
                    </select>
                    <select name="startDate" class="month selectpicker">
                        <option disabled selected="selected">Month</option>
                    </select>
                    <select name="startDate" class="year selectpicker">
                        <option disabled selected="selected">Year</option>
                    </select>
                </div>
                <div class="col-xs-12 col-sm-6 col-md-6 col-lg-4">
    ...
    <div id="footer">
        <div class="container">
            <div class="row">
                <div id="footer_article" class="col-xs-12 col-sm-6 col-md-6 col-lg-4">
    ...
    <div id="footer_links">
        <div class="container">
            <div class="row">
                <div id="footer_list" class="col-xs-12 col-sm-7 col-md-7 col-lg-7">
                ...
                <div id="footer_social" class="col-xs-12 col-sm-5 col-md-5 col-lg-5">
